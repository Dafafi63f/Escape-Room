...
Checklist **único** de trabajo pendiente e ideas futuras. El historial y el estado del proyecto están en [`CHANGELOG.md`](CHANGELOG.md).
...
2. **Hecha o descartada** → bórrala de aquí; si importa, una línea en el changelog de [`CHANGELOG.md`](CHANGELOG.md) §4.
3. **No dupliques** aquí el estado del proyecto ni el feedback del tutor (eso va en `CHANGELOG.md`).
...
- [ ] Modo feedback gráfico completo (envío SMTP; hoy referencia en consola)
