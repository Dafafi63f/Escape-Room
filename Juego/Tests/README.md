...
Comprueban reglas, informes, entrada de consola, feedback y configuración del modo libre. No son necesarias para jugar.
...
| `test_robustez_entrada.py` | Menús, teclas (H, F, Esc, Supr), `motor_partida` |
| `test_feedback.py` | Guardado local, SMTP, carga de `creador_privado.json` |
