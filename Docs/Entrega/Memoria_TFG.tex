...
Pruebas de regresión & \texttt{python -m unittest discover -s Tests -v} (\textbf{395} tests: 387 + 8 en \texttt{Files/}) \\
...
OE5 & Valor formativo & \textbf{Parcialmente cumplido} & Banco validado, 395 tests + CI; sin estudio con usuarios \\
\bottomrule
\end{tabular}
\fintabla
