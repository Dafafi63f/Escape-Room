...
2. Regenera ``Juego/Distribucion/juego_grafico.exe`` (``Juego/Scripts/build_exe_onefile.ps1``).
3. Limpia temporales (__pycache__, runtime del juego, intermedios de Entrega/, PyInstaller).
4. Crea ``Juego/Distribucion/MATCAD_juego_portable.zip`` (``Data/``, ``Juego/`` con código y ``Distribucion/``; sin ``.exe``/``.ps1``).
