...
Pruebas de regresión & \texttt{python -m unittest discover -s Tests -v} (51 tests) \\
Integración continua & GitHub Actions (\texttt{.github/workflows/ci.yml}) \\
...
Paquete de lógica & \texttt{Juego/Consola/} (19 módulos) \\
...
Pruebas & Suite en \texttt{Tests/} --- \textbf{51 tests} (\texttt{Tests/Juego/}, \texttt{Tests/Scripts/}); CI en GitHub Actions \\
\bottomrule
\end{tabular}
...
OE5 & \textbf{Parcialmente cumplido} & Banco validado, 51 tests + CI; sin estudio con usuarios \\
\bottomrule
\end{tabular}
\fintabla
