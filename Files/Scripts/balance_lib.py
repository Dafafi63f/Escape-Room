...
def _ejecutar_ajuste_intercambios(
    ...
    if ok_despues:
        ...
        if len(msgs_despues) > 12:
            print(f"  ... y {len(msgs_despues) - 12} más (python Files/Scripts/balance.py validar --detalle)")
    ...
    if not ok_despues:
        print("Prueba: python Files/Scripts/balance.py reordenar --solo-metadatos")
    return 0 if ok_despues else 1
...
def ejecutar_ajuste(
    ...
    if ok_despues:
        ...
        print("Prueba: python Files/Scripts/balance.py reordenar")
    return 0 if ok_despues else 1
